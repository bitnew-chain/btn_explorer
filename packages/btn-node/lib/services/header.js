...
const {
  BTN_GENESIS_HASH, BTN_GENESIS_TIMESTAMP, BTN_GENESIS_BITS, BTN_GENESIS_MERKLE_ROOT, BTN_GENESIS_NONCE,
  BTN_GENESIS_HASH_STATE_ROOT, BTN_GENESIS_HASH_UTXO_ROOT
} = require('../constants')
...
class HeaderService extends BaseService {
  constructor(options) {
    ...
    this.GENESIS_TIMESTAMP = BTN_GENESIS_TIMESTAMP
    this.GENESIS_BITS = BTN_GENESIS_BITS
    this.GENESIS_MERKLE_ROOT = BTN_GENESIS_MERKLE_ROOT
    this.GENESIS_NONCE = BTN_GENESIS_NONCE[this._network]
    this.GENESIS_HASH_STATE_ROOT = BTN_GENESIS_HASH_STATE_ROOT
    this.GENESIS_HASH_UTXO_ROOT = BTN_GENESIS_HASH_UTXO_ROOT
