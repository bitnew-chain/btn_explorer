...
function main(servicesPath, additionalServices) {
  ...
  let {create, add, start, remove, callMethod, findConfig, defaultConfig} = btn.scaffold
  ...
  program
    ...
    .option('-d, --data-dir <dir>', 'Specify the btn database directory')
  ...
  program
    ...
    .action(async services => {
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `btn-node install --help`')
      }
      let options = {
      ...
      console.log()
      console.log('    $ btn-node add btn-api')
      console.log()
    })
  ...
  program
    ...
    .action(async services => {
      let configInfo = findConfig(process.cwd())
      if (!configInfo) {
        throw new Error('Could not find configuration, see `btn-node uninstall --help`')
      }
      let options = {
        path: configInfo.path,
        services
      ...
      console.log('  Examples:')
      console.log()
      console.log('    $ btn-node remove btn-api')
      console.log()
    })
