...
function builder(options = {}) {
  options.network = options.network || btn.Networks.defaultNetwork
  options.Block = options.Block || btn.Block
  options.BlockHeader = options.BlockHeader || btn.BlockHeader
  options.Transaction = options.Transaction || btn.Transaction
  options.MerkleBlock = options.MerkleBlock || btn.MerkleBlock
