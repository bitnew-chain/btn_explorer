...
exports.versionGuard = function(version) {
  if (version !== undefined) {
    console.log(
      'More than one instance of btn-lib found.',
      'Please make sure to require btn-lib and',
      'check that submodules do not also include their own btn-lib dependency.'
    )
  }
}
exports.versionGuard(global._btn)
global._btn = exports.version
